    ...
    <div className="form">
      ...
      <div className="form-item">
        <InputNumber
          ...
          onChange={(value) =>
            setInputData((prevInputData) => ({
              ...prevInputData,
              station_frequency: value,
            }))
          }
          name="station_frequency"
          value={inputData.station_frequency}
          min={97}
          max={120}
          style={{
            borderRadius: "2px",
      ...
      <div className="form-item">
        <TextArea
          ...
          value={inputData.station_description}
          onChange={() => handleChange(event)}
      ...
      <div className="form-item upload">
        ...
        <Input
          ...
          onChange={(event) => {
            ...
            setInputData((prevInputData) => ({
              ...prevInputData,
              station_cover: event.target.files[0],
            }));
          }}
        />
      </div>
